...
@implementation RelatedArticleParser
...
-(void)getRelatedArticle:(NSInteger)articleId;
{
    ...
    NSString *soapMessage = [NSString stringWithFormat:
							 @"%@"
							 "<SOAP-ENV:Body> \n"
                             "<GetRelatedArticles xmlns=\"%@/\">"
							 "<ShowingArticleID>%i</ShowingArticleID> \n"
    ...
    [theRequest addValue:[NSString stringWithFormat:@"%@/GetRelatedArticles", BaseUrl] forHTTPHeaderField:@"Soapaction"];
...
-(void)getRelatedVideos:(NSInteger)articleId;
{
   ...
   //NSLog(@"%@", soapMessage);
    ...
    NSString *msgLength = [NSString stringWithFormat:@"%d", [soapMessage length]];          
    [theRequest addValue: @"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];       
    [theRequest addValue:[NSString stringWithFormat:@"%@/GetRelatedVideos", BaseUrl] forHTTPHeaderField:@"Soapaction"];
    [theRequest addValue: msgLength forHTTPHeaderField:@"Content-Length"];
    [theRequest setHTTPMethod:@"POST"];     
    [theRequest setHTTPBody: [soapMessage dataUsingEncoding:NSUTF8StringEncoding]];
    NSURLConnection *theConnection = [[[NSURLConnection alloc] initWithRequest:theRequest delegate:self]autorelease];
