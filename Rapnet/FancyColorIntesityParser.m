...
@implementation FancyColorIntesityParser

@synthesize webData,xmlParser,results,delegate;

static NSString * const kMethodName = @"GetFancyColorIntensities";
...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    [delegate DownloadFinished:LT_TableFancyColorIntensities result:arr];	
}
