...
@implementation FancyColorOvertoneParser

@synthesize webData,xmlParser,results,delegate;

static NSString * const kMethodName = @"GetFancyColorOvertones";
...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    [delegate DownloadFinished:LT_TableFancyColorOvertones result:arr];	
}
