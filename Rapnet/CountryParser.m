...
static NSString * const kMethodName = @"GetCountries";
static NSString * const kCountryIDName = @"CountryID";
static NSString * const kCountryTitleName = @"CountryTitle";
...
-(void)parser:(NSXMLParser *)parser foundCharacters:(NSString *)string
{
	...
	if ([currentElement isEqualToString:kCountryIDName]){
		[value  appendString:string];
	}else if ([currentElement isEqualToString:kCountryTitleName]){
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
	if ([elementName isEqualToString:kTableElementName])
	{
        ...
        [data setObject:[NSString stringWithFormat:@"%d", curListOrder] forKey:kListOrderElementName];
        curListOrder++;
...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    [delegate DownloadFinished:LT_TableCountry result:arr];	
}
