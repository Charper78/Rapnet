...
#import "Enums.h"
#import "LT_Const.h"
@protocol PolishDelegate
-(void)DownloadFinished:(LT_Tables)type result:(NSMutableArray*)result;
@end



@interface PolishParser : NSObject <NSXMLParserDelegate>{
    id<PolishDelegate> delegate;
...
@property(retain, nonatomic) id<PolishDelegate> delegate;
