...
@implementation GetGridSizeParser
...
-(void)GetGridSize{
    ...
    NSString *soapMessage = [NSString stringWithFormat:
                             ...
                             "<SOAP-ENV:Body> \n"
                             "<GetGridSizes xmlns=\"%@/\"> \n"
                             "<PriceListType>ROUND</PriceListType>\n"
    ...
    [theRequest addValue:[NSString stringWithFormat:@"%@/GetGridSizes", BaseUrl] forHTTPHeaderField:@"Soapaction"];
...
-(void)parserDidEndDocument:(NSXMLParser *)parser{
    //NSLog(@"xml ended");
    [delegate webserviceCallGridSizeFinished];	
}
