...
#define PnsUrl @"http://app14.rapaport.com/apple-app/pushnotifications.asmx"
//#define PnsUrl @"http://ik.somee.com/WebSite/pns.asmx"
#define PnsBaseUrl @"http://ik.somee.com"
